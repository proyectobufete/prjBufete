...
use AppBundle\Entity\Exoneraciones;
...
class ExoneracionesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $exoneraciones = $em->getRepository('AppBundle:Exoneraciones')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\ExoneracionesType', $exoneracione);
    ...
    {
        $deleteForm = $this->createDeleteForm($exoneracione);
        $editForm = $this->createForm('AppBundle\Form\ExoneracionesType', $exoneracione);
