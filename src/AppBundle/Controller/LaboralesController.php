...
class LaboralesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $laborales = $em->getRepository('AppBundle:Laborales')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\LaboralesType', $laborale);
    ...
    {
        $deleteForm = $this->createDeleteForm($laborale);
        $editForm = $this->createForm('AppBundle\Form\LaboralesType', $laborale);
