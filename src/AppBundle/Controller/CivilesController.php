...
class CivilesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $civiles = $em->getRepository('AppBundle:Civiles')->findAll();
    ...
    {
        $civile = new Civiles();
        $form = $this->createForm('AppBundle\Form\CivilesType', $civile);
    ...
    {
        $deleteForm = $this->createDeleteForm($civile);
        $editForm = $this->createForm('AppBundle\Form\CivilesType', $civile);
