...
class PracticasController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $practicas = $em->getRepository('AppBundle:Practicas')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\PracticasType', $practica);
    ...
    {
        $deleteForm = $this->createDeleteForm($practica);
        $editForm = $this->createForm('AppBundle\Form\PracticasType', $practica);
