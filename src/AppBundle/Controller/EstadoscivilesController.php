...
use AppBundle\Entity\Estadosciviles;
...
class EstadoscivilesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $estadosciviles = $em->getRepository('AppBundle:Estadosciviles')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\EstadoscivilesType', $estadoscivile);
    ...
    {
        $deleteForm = $this->createDeleteForm($estadoscivile);
        $editForm = $this->createForm('AppBundle\Form\EstadoscivilesType', $estadoscivile);
