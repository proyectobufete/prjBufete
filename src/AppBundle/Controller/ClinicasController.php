...
class ClinicasController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $clinicas = $em->getRepository('AppBundle:Clinicas')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\ClinicasType', $clinica);
    ...
    {
        $deleteForm = $this->createDeleteForm($clinica);
        $editForm = $this->createForm('AppBundle\Form\ClinicasType', $clinica);
