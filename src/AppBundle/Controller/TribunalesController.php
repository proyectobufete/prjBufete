...
use AppBundle\Entity\Tribunales;
...
class TribunalesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tribunales = $em->getRepository('AppBundle:Tribunales')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\TribunalesType', $tribunale);
    ...
    {
        $deleteForm = $this->createDeleteForm($tribunale);
        $editForm = $this->createForm('AppBundle\Form\TribunalesType', $tribunale);
