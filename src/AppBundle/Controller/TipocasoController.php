...
class TipocasoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tipocasos = $em->getRepository('AppBundle:Tipocaso')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\TipocasoType', $tipocaso);
    ...
    {
        $deleteForm = $this->createDeleteForm($tipocaso);
        $editForm = $this->createForm('AppBundle\Form\TipocasoType', $tipocaso);
