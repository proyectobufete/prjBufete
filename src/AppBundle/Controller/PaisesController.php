...
class PaisesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $paises = $em->getRepository('AppBundle:Paises')->findAll();
    ...
    {
        $paise = new Paises();
        $form = $this->createForm('AppBundle\Form\PaisesType', $paise);
    ...
    {
        $deleteForm = $this->createDeleteForm($paise);
        $editForm = $this->createForm('AppBundle\Form\PaisesType', $paise);
