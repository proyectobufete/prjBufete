...
class BufetesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $bufetes = $em->getRepository('AppBundle:Bufetes')->findAll();
    ...
    {
        $bufete = new Bufetes();
        $form = $this->createForm('AppBundle\Form\BufetesType', $bufete);
    ...
    {
        $deleteForm = $this->createDeleteForm($bufete);
        $editForm = $this->createForm('AppBundle\Form\BufetesType', $bufete);
