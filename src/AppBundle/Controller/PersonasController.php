...
class PersonasController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $personas = $em->getRepository('AppBundle:Personas')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\PersonasType', $persona);
    ...
    {
        $deleteForm = $this->createDeleteForm($persona);
        $editForm = $this->createForm('AppBundle\Form\PersonasType', $persona);
